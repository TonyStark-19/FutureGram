...
const Header = () => {
  return (
    <header className="bg-[#050405] text-white flex justify-between items-center px-6 py-4 shadow-[0_0_10px_#ba72bc]">
      {/* Logo */}
      <div className="text-3xl font-bold tracking-wider text-transparent bg-clip-text bg-gradient-to-r from-[#ba72bc] via-[#ff88ff] to-[#ffd6e0] drop-shadow-[0_0_10px_#ba72bc]">
